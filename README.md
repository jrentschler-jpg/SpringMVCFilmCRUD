...
Choosing to update a given entry will navigate to an update page where entry fields are <img align="left" src="/images/Screen Shot 2020-10-19 at 1.52.15 AM.png"  width="227" height="114"> automatically populated and the user is able to manage each field as they wish. Upon successful update the user is navigated to a confirmation screen.
